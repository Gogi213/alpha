...
//! **нулевые во всех записях** (`docs/archive/findings/binlog-format-2026-09-13.md`,
...
//! (измерено таском 25, `docs/archive/findings/collector-2026-09-12.md`).
//!
...
/// `docs/archive/findings/binlog-format-2026-09-13.md`), у `Record` нет вовсе: экспортёр
...
/// числовой ответ, а не оценку на глаз (`docs/archive/findings/binlog-format-2026-09-13.md`,
