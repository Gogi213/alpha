...
pub(super) struct StreamState {
    ...
    /// сообщение — `docs/archive/findings/collector-2026-09-12.md`, «Замер до»:
...
/// docs/archive/findings/collector-2026-09-12.md`, «Замер до». `Err` — кадр не записался
...
/// сообщение сессии без потолка — `docs/archive/findings/collector-2026-09-12.md`,
