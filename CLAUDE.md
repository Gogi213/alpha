...
docs/
  ...
  findings/         боевые замеры и разборы, на которые ссылаются код, план и память
  archive/          всё заменённое: findings прошлых волн, черновики плана, сырые
                    расшифровки, артефакты старых прогонов, старые пулы
```
