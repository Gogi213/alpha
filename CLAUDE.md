...
Первый перенос — сутки 09-16 и 09-17 (7.4 ГБ, 13 мин). **Гейт переезда пройден:** круги HYPE 09-17 на новой машине побайтово те же, что на коллекторском сервере (997 721 круг, md5 совпал); сутки HYPE в 3 потока — 26 с против 65 на одном. Ранбук — `docs/COMMANDS.md` п. 10. Замечание к интервалу
