...
- Замер (`docs/findings/collector-2026-09-12.md`, «761»): 8 → 761: CPU 2.0 → 24.2 % (0.253 → 0.032 %/инстр.), RSS 17.8 → 159.5 МиБ (215 КиБ/инстр.), 6.9 КБ/мин/инстр., байт/запись 6.38, parse p99 87 мкс, queue p99 27.8 мс (долг живого бота), 7.75 ГБ/сутки.
