window.STATE =
{
  ...
  "updatedAt": "2026-09-12T12:10:00+04:00",
  "finishedAt": null,
  ...
  "stages": [
    ...
    },
    {
      ...
      "note": "Волна 8 (после сдачи, по решению владельца 2026-09-12): T20 экономность записи на коротких прогонах, T21 окно «сейчас». Длинные прогоны заморожены до зелёного T20",
    ...
    },
    {
      ...
      "note": "сдан 2026-09-12: слепая приёмка G4 — 5 расхождений, одно починено (таск 19), четыре в отчёте; память CLAUDE.md, 12 ADR; каталог прогона без --wip"
    }
  ],
  "requirements": {
    "total": 85,
  ...
  "gates": [
    ...
    },
    {
      "id": "GC",
      "status": "passing",
      "note": "таск 01: clippy 0, fmt 0, 448 тестов; аллокации и реакционный путь — с таска 04/15"
    },
    {
      "id": "G-LAT",
      "status": "pending",
    ...
    },
    {
      "id": "G-POWER-B",
      "status": "pending",
      "note": "замеренный Шарп против требуемого — таск 09. Разведка: −0.40 / −0.32 / +0.24 против ≈2.7"
    },
    {
      "id": "G0",
      "status": "pending",
    ...
    },
    {
      "id": "G1",
      "status": "pending",
      "note": "eaten и pulled ≥ 5%. Разведка: eaten 2.3% / 7.1% / 1.5%"
    },
    {
      "id": "G2-в",
      "status": "pending",
  ...
  "concerns": [
    ...
    },
    {
      ...
      "what": "profiles/shortlist читают все подкаталоги root без окна фиксированной длины по сессиям; длина окна нигде не печатается — открытый вопрос владельцу: длина окна (сутки/сессии) назначается до данных",
      "kind": "open"
    }
  ],
  "debt": [
