window.STATE =
{
  ...
  "stages": [
    ...
    },
    {
      ...
      "note": "22 таска (19 сборки + 20/21 после сдачи по решению владельца). Запись доказана на коротких прогонах: gaps 0, verify чист, CPU 4 %, RSS плоский; разбор p99 над калибровочным суббюджетом",
      "finishedAt": "2026-09-12T15:30:00+04:00"
    },
    {
      "id": "review",
  ...
  "gates": [
    ...
    },
    {
      "id": "GC",
      "status": "passed",
      "note": "на пуле из 8 (T20 9c16430): clippy 0, fmt 0, аллокации ноль (тесты), CPU 3.6–4.1 % < 5 %, RSS плоский после прогрева, gaps 0, clock.csv есть; разбор p99 462–851 мкс > 200 мкс калибровочных — единственная строка над суббюджетом"
    },
    {
      "id": "G-LAT",
      "status": "pending",
