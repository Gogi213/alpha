window.STATE =
{
  ...
  "updatedAt": "2026-09-11T02:05:00+04:00",
  "finishedAt": null,
  ...
  "stages": [
    ...
    { "id": "build",     "status": "pending", "note": "ждёт повторного G2 и решения по CLUSDT; работа по умолчанию не заблокирована" },
  ...
  "tickets": [
    { "id": "01", "title": "Вычистить отменённое и разрезать commands/lob.rs", "requirements": ["R18","R19","R32","R37","R43","R49","R71","R73"], "blockedBy": [], "wave": 1, "zone": ["src/","docs/plan/"], "status": "pending", "retries": 0, "repairs": 0, "handoffs": 0 },
    { "id": "02", "title": "H3 как пол; размер как ось; скользящий час снесён", "requirements": ["R14","R40"], "blockedBy": ["01"], "wave": 2, "zone": ["src/lob/levels.rs"], "status": "pending", "retries": 0, "repairs": 0, "handoffs": 0 },
    ...
    { "id": "09", "title": "Пилот: серия прогонов ≤5 мин; G0; G-POWER-B; ставка уровней", "requirements": ["R40","R51","R68","R78","R81","A01"], "blockedBy": ["01","02","08"], "wave": 3, "zone": ["src/commands/lob/pilot.rs"], "status": "pending", "retries": 0, "repairs": 0, "handoffs": 0 },
  ...
  "gates": [
    ...
    { "id": "G2",        "status": "running", "note": "повторно на вторую редакцию спеки; первая дала 17 находок, все внесены" },
  ...
  "reviewers": {
    "R-A": { "axes": ["manifest","spec"], "handle": null, "lifetime": "до границы волны" },
    "R-B": { "axes": ["craft"],           "handle": null, "lifetime": "весь прогон" },
    "R-C": { "axes": ["data","prereg"],   "handle": null, "lifetime": "весь прогон, освежать нельзя" }
  },

  "coverage": { "findings": 17, "acted": 17, "note": "первая редакция спеки; повторный G2 на вторую — идёт" },
