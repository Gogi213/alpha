window.STATE =
{
  ...
  "stages": [
    ...
    { "id": "spec",      "status": "done", "startedAt": "2026-09-08T02:12:00+04:00", "finishedAt": "2026-09-08T02:22:00+04:00", "note": "23 решения, гейты G0-G4 и GC, предрегистрация" },
    { "id": "plan",      "status": "active", "startedAt": "2026-09-08T02:22:00+04:00", "note": "ревизия 7 готова. КОДА НАПИСАНО НОЛЬ: 0 из 21 таска, 0 из 10 требований, 0 гейтов" },
  ...
  "tickets": [
    ...
    { "id": "0.1", "title": "Bybit WS: книга, u=1, size=0, cts, local_ts по возврату из recv", "requirements": ["R06", "R08"], "blockedBy": ["0.0"], "wave": 2, "zone": ["src/bybit/ws.rs"], "status": "pending", "retries": 0, "repairs": 0, "handoffs": 0 },
    ...
    { "id": "6.2", "title": "lob probe: RTT, HMAC-SHA256, ключи из окружения", "requirements": ["R04", "R08"], "blockedBy": ["0.0"], "wave": 2, "zone": ["src/bybit/probe.rs"], "status": "pending", "retries": 0, "repairs": 0, "handoffs": 0 },
    { "id": "0.2", "title": "Бинарный лог: сутки самодостаточны, кадры с u32 длины, надмножество Event", "requirements": ["R06", "R08"], "blockedBy": ["0.1"], "wave": 3, "zone": ["src/bybit/binlog.rs"], "status": "pending", "retries": 0, "repairs": 0, "handoffs": 0 },
    ...
    { "id": "0.5", "title": "lob clock: смещение против NTP и serverTime, clock.csv раз в час", "requirements": ["R08"], "blockedBy": ["0.1"], "wave": 3, "zone": ["src/bybit/clock.rs"], "status": "pending", "retries": 0, "repairs": 0, "handoffs": 0 },
    ...
    { "id": "1.1", "title": "lob levels: жизнь уровня + шесть признаков истории колонками", "requirements": ["R01", "R10"], "blockedBy": ["0.2"], "wave": 4, "zone": ["src/lob/levels.rs"], "status": "pending", "retries": 0, "repairs": 0, "handoffs": 0 },
    ...
    { "id": "5.2", "title": "Ячейки C1 и C2, разность с интервалом, гейт G2", "requirements": ["R02", "R10"], "blockedBy": ["5.1", "2.1", "7.2"], "wave": 10, "zone": ["src/lob/markout.rs"], "status": "pending", "retries": 0, "repairs": 0, "handoffs": 0 },
    { "id": "5.3", "title": "Издержки и проскальзывание по Decision 15, гейт G3", "requirements": ["R03"], "blockedBy": ["5.2"], "wave": 11, "zone": ["docs/findings/"], "status": "pending", "retries": 0, "repairs": 0, "handoffs": 0 },
