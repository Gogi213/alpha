window.STATE =
{
  ...
  "updatedAt": "2026-09-11T08:50:00+04:00",
  "finishedAt": null,
  ...
  "stages": [
    ...
    { "id": "build",     "status": "active", "startedAt": "2026-09-11T02:20:00+04:00", "note": "Волна 2 закрыта: T02/T03/T04/T06 закоммичены. В полёте T05, T07, T08; T15 — после T05 (mod.rs); T09 — после T08. 5 из 15 готово" },
  ...
  "requirements": {
    "total": 85, "done": 23, "inTicket": 58, "deferred": 4, "dropped": 0, "placeholder": 0, "open": 0,
  ...
  "tickets": [
    ...
    { "id": "05", "title": "lob power: планка до сбора (G-POWER-A)", "requirements": ["R47","R59","R68","A01"], "blockedBy": ["01"], "wave": 2, "zone": ["src/lob/final_metrics.rs","src/commands/lob/power.rs"], "status": "in-progress", "startedAt": "2026-09-11T08:05:00+04:00", "retries": 0, "repairs": 0, "handoffs": 0 },
    ...
    { "id": "08", "title": "lob pick начисто: пул заморожен, пол H3", "requirements": ["R14","R21","R22","R23","R24","R25","R26","R27","R28","R29","R30","R31","R33","R34","R35","R36","R69"], "blockedBy": ["01"], "wave": 2, "zone": ["src/commands/lob/pick.rs","docs/plan/candidates.csv","instruments.csv"], "status": "in-progress", "startedAt": "2026-09-11T08:50:00+04:00", "retries": 0, "repairs": 0, "handoffs": 0 },
    { "id": "07", "title": "lob watch на сессиях", "requirements": ["R39","R42","R49","R77i"], "blockedBy": ["01","04"], "wave": 3, "zone": ["src/lob/watch.rs"], "status": "in-progress", "startedAt": "2026-09-11T08:50:00+04:00", "retries": 0, "repairs": 0, "handoffs": 0 },
  ...
  "blind": null,
  "tests": { "passed": 472, "failed": 0, "ignored": 5, "at": "2026-09-11T08:45:00+04:00" }
}
