window.STATE =
{
  ...
  "updatedAt": "2026-09-10T00:21:24+04:00",
  "finishedAt": null,
  "stages": [
    {
      "id": "preflight",
    ...
    },
    {
      ...
      "note": "ревизия 17: бизнес-задача редакции 2 — десять инструментов, профили вместо двух ячеек, перебор под учётом. Затронуты 0.4, 1.1, 3.1, 5.2, 5.3, 7.1; новый шаг 5.4"
    },
    {
      "id": "review",
      "status": "pending"
  ...
  "tickets": [
    ...
    },
    {
      ...
      "concerns": [
        "ревизия 17 сменила бизнес-задачу (BUSINESS-TASK.md, редакция 2): пул — десять старших по обороту после исключений (Decision 25), нужна колонка excluded_reason; правило средней трети отменено",
    ...
    },
    {
      ...
      "concerns": [
        "ревизия 17 сменила бизнес-задачу (BUSINESS-TASK.md, редакция 2): пилот по всем десяти инструментам пула, пороги GC перемеряются на десяти, гейт G0 переписан на медиану и объединённую выборку",
